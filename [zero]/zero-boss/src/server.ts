...
onNet("Zero:Server-Bossmenu:SetGrade", (playerId:any, Grade:any) => {
    var src = source;
...
onNet("Zero:Server-Bossmenu:Hire", (playerId:any) => {
    var src = source;
...
onNet("Zero:Server-Bossmenu:Fire", (playerId:any) => {
    var src = source;
