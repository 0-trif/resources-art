...
window.CONFIG = {
  ...
  templates: { //You can add static templates here
    ...
    'defaultAlt': '{0}',
    'print': '<div class="chat-message error"><span class="chat-message-label">DEBUG</span><div class="chat-message-body"><strong><span class="first-argument">{1}</span>:</strong> {0}</div></div>',
